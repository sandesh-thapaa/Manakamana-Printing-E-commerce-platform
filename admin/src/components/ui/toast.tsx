  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border border-slate-200 p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full dark:border-slate-800",
  {
    variants: {
      variant: {
        ...
        success:
          "success group border-emerald-200 bg-emerald-50 text-emerald-900 dark:border-emerald-900/50 dark:bg-emerald-900/40 dark:text-emerald-100",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-slate-200 bg-transparent px-3 text-sm font-medium ring-offset-white transition-colors hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-slate-100/40 group-[.destructive]:hover:border-red-500/30 group-[.destructive]:hover:bg-red-500 group-[.destructive]:hover:text-slate-50 group-[.destructive]:focus:ring-red-500 group-[.success]:border-emerald-200 group-[.success]:hover:border-emerald-300 group-[.success]:hover:bg-emerald-100 group-[.success]:hover:text-emerald-900 group-[.success]:focus:ring-emerald-300 dark:border-slate-800 dark:ring-offset-slate-950 dark:hover:bg-slate-800 dark:group-[.destructive]:border-slate-800/40 dark:group-[.destructive]:hover:border-red-900/30 dark:group-[.destructive]:hover:bg-red-900 dark:group-[.destructive]:hover:text-slate-50 dark:group-[.destructive]:focus:ring-red-900 dark:group-[.success]:border-emerald-800/60 dark:group-[.success]:hover:border-emerald-700 dark:group-[.success]:hover:bg-emerald-900/60 dark:group-[.success]:hover:text-emerald-50 dark:group-[.success]:focus:ring-emerald-700",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-slate-950/50 opacity-0 transition-opacity hover:text-slate-950 focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600 group-[.success]:text-emerald-700 group-[.success]:hover:text-emerald-900 group-[.success]:focus:ring-emerald-300 group-[.success]:focus:ring-offset-emerald-50 dark:text-slate-50/50 dark:hover:text-slate-50 dark:group-[.success]:text-emerald-200 dark:group-[.success]:hover:text-emerald-50 dark:group-[.success]:focus:ring-emerald-700 dark:group-[.success]:focus:ring-offset-emerald-900",
      className
    )}
    toast-close=""
    {...props}
